    ...
    return (
        <div key={chapter.id} /* ... */>
            <div className="flex items-center gap-4">
                ...
                <span className={`font-mono text-sm /* ... */`}>{String(chapter.chapter_number).padStart(2, '0')}</span>
                
                <div>
                    {/* Добавим || \`Глава \${chapter.chapter_number}\` на случай, 
                      если у главы (например, "главы 0") нет отдельного названия.
                    */}
                    <p className={`font-semibold /* ... */`}>{chapter.title || `Глава ${chapter.chapter_number}`}</p>
